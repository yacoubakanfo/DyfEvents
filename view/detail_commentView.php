    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Details des evenements</h2>
          <ol>
            <li><a href="index.php">Accueil</a></li>
            <li>Details des evenements</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3>Informations sur l'evenement</h3>
            <ul>
              <li><strong>Nom</strong>: <?=$value->getName()?></li>
              <li><strong>Description</strong>: <?=$value->getDescription()?></li>
              <li><strong>Date de début</strong>: <?=$value->getDateBegin()?></li>
              <li><strong>Date de fin</strong>: <?=$value->getDateEnd()?></li>
              <li><strong>Organisateur</strong>: <?=$value->getPlanner()?></li>
            </ul>
          </div>

        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="index.php?action=logout"><i class="icon_key_alt"></i> Déconnexion</a>
              </li>
            </ul>
          </li>
                  ...
                  <form class="form-validate form-horizontal" id="feedback_form" action="../controller/Update.php" method="POST">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <button class="btn btn-default" type="button"><a href="index.php?action=lister"> Annuler</a></button>
                      </div>
                    </div>
                  </form>
                </div>

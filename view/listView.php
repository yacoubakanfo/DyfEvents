                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-success" href="../view/updateView.php" title="Mettre à jour"><i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="../controller/Delete.php" title="Supprimer"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php
